...
Main-haarassa on julkaistu tuotantokäyttöön otettujen palveluiden rajapintakuvaukset.
...
## OpenApi-kuvaukset
Rajapintojen kuvaukset löytyvät OpenApi-kansiosta. OpenApi-kuvaukset ovat JSON-muodossa ja niitä voi katsella esim. https://editor.swagger.io/ sivuston avulla kopioimalla JSON-tiedoston sisällön sinne.
...
Dokumentaatiot-kansiosta löytyy yleisiä ohjeita rajapintojen käyttöön.

Ryhti-sivustolla julkaistua dokumentaatiota:
...
## Aikataulu
Ryhti-työn aikataulua on avattu [Ryhti-sivustolla](https://ryhti.syke.fi/tietoa-jarjestelmasta/aikataulu-ja-kehittaminen/)
